...
impl Parse for FunctionCall {
    fn parse(p: &mut Parser) -> Option<Self> {
        p.with_help("encountered while parsing function call",
                    |p| -> Option<Self> {
                        p.token(Token::Tilde)?;
...
impl Parse for TypeDeclaration {
    fn parse(p: &mut Parser) -> Option<Self> {
        p.with_help("encountered while parsing type declaration",
                    |p| -> Option<Self> {
...
impl Parse for TypeVariant {
    fn parse(p: &mut Parser) -> Option<Self> {
        p.with_help("encountered while parsing type variant",
                    |p| -> Option<Self> {
                        let mut buf = vec![];
                        let name = p.parse()?;
                        loop {
...
impl Parse for FunctionDeclaration {
    fn parse(p: &mut Parser) -> Option<Self> {
        p.with_help("encountered while parsing function declaration",
                    |p| -> Option<Self> {
...
impl Parse for FunctionParameter {
    fn parse(p: &mut Parser) -> Option<Self> {
        p.with_help("encountered while parsing function parameter",
                    |p| -> Option<Self> {
...
impl Parse for IntrinsicCall {
    fn parse(p: &mut Parser) -> Option<Self> {
        p.with_help("encountered while parsing intrinsic call",
                    |p| -> Option<Self> {
